...
<section class="atulya-last j-center" >
    <div class="container">
        ...
        <div class="col-lg-6">
            <p class="medium" style="margin-bottom: -1.5rem;">For any of the above handicrafts, drop a mail to <a href="mailto:sales@atulyafoundation.org">sales@atulyafoundation.org</a> </p>
        </div>
        <div class="col-lg-3"></div>
    </div>
    </div>
