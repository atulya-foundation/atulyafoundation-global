                ...
                <form action="#" method="post">
                    <div class="row">
                        <div class="col-xl-5">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="txt_age" placeholder="AGE">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="txt_gender" placeholder="GENDER">
                            </div>
                        </div>
                    ...
                    <div class="row with-top">
                        ...
                        <div class="col-xl-5">
                            <div class="form-group">
                                <input type="text" class="form-control" name="txt_street_1" placeholder="STREET 1">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="txt_street_2" placeholder="STREET 2">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="txt_city" placeholder="CITY">
                            </div>
                        </div>
                        <div class="col-xl-2 view-desktop"></div>
                        <div class="col-xl-5">
                            <div class="form-group">
                                <input type="text" class="form-control" name="txt_state" placeholder="STATE">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="txt_pincode" placeholder="PINCODE">
                            </div>
                        </div>
                    </div>
                    <div class="row with-top">
