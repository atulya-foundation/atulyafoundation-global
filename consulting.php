    ...
    <div class="container">
        ...
        <div class="web-wrap">
            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-12">
                        <p class="intro" style="padding-left: 24px; padding-right: 0px!important; color: #707070;">Art is mostly looked as a product but very less as a service. We
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <p>We advise in selecting suitable pieces of artworks that will enhance the aesthetics and culture our client wants to develop. We bring to use augmented
                            reality to showcase our clients and make them feel how beautiful their space can look. We offer entire range of artworks such as original hand painted
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-11">
                            <p>We lease out artworks as per the requirements of our clients at an affordable cost. Clients select artworks of their choice from our collection, we
                                ship it to them and get it installed at the site. On completion of leasing period, they can end up or may extend up by choosing replacement artworks
                                to the installed ones. This gives them an opportunity to refresh the looks of their space at intervals.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <p>We provide customised framing options which compliments to the existing design of the site. We have wide range of options from exotic hand-crafted
                                wooden frames to synthesised vinyl frames. Things such as height & angle an artwork should be installed at makes a huge difference in visual appeal
                                of an art piece. We have trained installers who can optimally install artworks so they are in right field of view.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <p>We always advise our clients to have more & more local artworks in their spaces. It makes them remain connected to their regional roots and at the
                                same time giving back to their local artists community. Our team brings out the arts and artist even from the remotest regions of the geography that
                                deserve much more appreciation and recognition. All thanks to our artists network.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <p>We understand art is something to which you attach yourself over time and it becomes a part of your daily visual treat. Well! here restoration helps
                                artworks to remain new and shiny. Restoration is majorly done for oil paintings as the colours fade over a period of time. Our expert artists team
                                is versed in restoring heritage and traditional artworks of all sorts and can give them a refreshed look. </p>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="atulya-last j-center">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6">
                <p class="medium" style="margin-bottom: -1.5rem;">For any of the above services, drop a mail to <a href="mailto:sales@atulyafoundation.org">sales@atulyafoundation.org</a>
                </p>
            </div>
            <div class="col-lg-3"></div>
        </div>
